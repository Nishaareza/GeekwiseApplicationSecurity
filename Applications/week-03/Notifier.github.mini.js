var Notifier = function () {
    ...
    var config = {
        ...
        container_styles: {position: "fixed", zIndex: 99999, right: "12px", top: "12px"},
        box_styles: {
            cursor: "pointer",
            padding: "12px 18px",
            margin: "0 0 6px 0",
        ...
        box_styles_hover: {opacity: 1, boxShadow: "#000 0 0 12px"},
        title_styles: {fontWeight: "700"},
        text_styles: {display: "inline-block", verticalAlign: "middle", width: "240px", padding: "0 12px"},
        icon_styles: {display: "inline-block", verticalAlign: "middle", height: "36px", width: "36px"}
    };
